...
* [StreetComplete](https://github.com/westnordost/StreetComplete) ⭐ 4,464 | 🐛 127 | 🌐 Kotlin | 📅 2026-02-08 - App for improving OSM by answering simple questions. ([Android](https://play.google.com/store/apps/details?id=de.westnordost.streetcomplete) / [Wiki](https://wiki.openstreetmap.org/wiki/StreetComplete))
...
* [Vespucci](https://vespucci.io/) - Advanced full-data-model editor for Android. ([Android](https://play.google.com/store/apps/details?id=de.blau.android) / [Source Code](https://github.com/MarcusWolschon/osmeditor4android) ⭐ 440 | 🐛 199 | 🌐 Java | 📅 2026-02-08 / [Wiki](https://wiki.openstreetmap.org/wiki/Vespucci))
...
* [better-osm-org](https://github.com/deevroman/better-osm-org) ⭐ 165 | 🐛 156 | 🌐 JavaScript | 📅 2026-02-08 - Userscript that adds visualization of changesets and many other useful features to OSM website.
...
* [Organic Maps](https://organicmaps.app/) - A free offline maps app based on OSM. (Android, iOS / [Source Code](https://github.com/organicmaps/organicmaps) ⭐ 13,233 | 🐛 3,199 | 🌐 C++ | 📅 2026-02-08 / [Wiki](https://wiki.openstreetmap.org/wiki/Organic_Maps))
* [OsmAnd](https://osmand.net) - Map viewing and navigation (routing) application with offline functionality available for Android and iOS. (Android, iOS / [Source Code Android](https://github.com/osmandapp/OsmAnd) ⭐ 5,535 | 🐛 3,320 | 🌐 Java | 📅 2026-02-08 / [Source Code iOS](https://github.com/osmandapp/OsmAnd-iOS) ⭐ 328 | 🐛 294 | 🌐 Objective-C++ | 📅 2026-02-08 / [Wiki](https://wiki.openstreetmap.org/wiki/OsmAnd))
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 8,285 | 🐛 78 | 🌐 Rust | 📅 2026-02-08 - Generate cities from real life in Minecraft using Python.
...
* [OSRM](https://github.com/Project-OSRM/osrm-backend) ⭐ 7,459 | 🐛 441 | 🌐 C++ | 📅 2026-02-06 -  Routing engine for use in C++ applications. ([Wiki](https://wiki.openstreetmap.org/wiki/Open_Source_Routing_Machine))
...
* [Leaflet](https://leafletjs.com/) - An open-source JavaScript library for mobile-friendly interactive maps. ([Source Code](https://github.com/Leaflet/Leaflet) ⭐ 44,474 | 🐛 540 | 🌐 JavaScript | 📅 2026-02-02 / [Wiki](https://wiki.openstreetmap.org/wiki/Leaflet))
* [OpenLayers](https://openlayers.org/) - A high-performance library for rendering raster and vector maps. ([Source Code](https://github.com/openlayers/openlayers) ⭐ 12,318 | 🐛 871 | 🌐 JavaScript | 📅 2026-02-07 / [Wiki](https://wiki.openstreetmap.org/wiki/OpenLayers))
* [MapLibre GL JS](https://maplibre.org/projects/#js) - A map renderer with GPU-accelerated vector tile rendering. ([Source Code](https://github.com/maplibre/maplibre-gl-js) ⭐ 9,847 | 🐛 409 | 🌐 TypeScript | 📅 2026-02-08 / [See Related List](#related-awesome-maplibre))
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 349 | 🐛 34 | 🌐 Python | 📅 2026-02-08 - A Python library for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [python-mapnik](https://github.com/mapnik/python-mapnik) ⭐ 174 | 🐛 154 | 🌐 Python | 📅 2026-02-08 - Python wrapper for mapnik.
...
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,541 | 🐛 147 | 🌐 Java | 📅 2026-02-07 - Open source multi-modal trip planner. ([Wiki](https://wiki.openstreetmap.org/wiki/OpenTripPlanner))
...
* [awesome-maplibre](https://github.com/maplibre/awesome-maplibre#readme) ⭐ 906 | 🐛 0 | 📅 2026-01-31 - A collection of awesome things that use or support MapLibre! <span id="related-awesome-maplibre"/>
